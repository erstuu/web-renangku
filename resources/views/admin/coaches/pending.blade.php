...
<head>
    ...
    <title>Coach Menunggu Approval - Admin Web Renangku</title>
        ...
        <div class="flex-1 p-6">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800">Coach Menunggu Approval</h2>
                        <p class="text-gray-600 mt-2">Review dan kelola pendaftaran coach yang pending</p>
                    </div>
                    <a href="{{ route('admin.coaches.index') }}"
                        class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
                        <i class="fas fa-users mr-2"></i>Semua Coach
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-3xl font-bold text-gray-900">{{ $pendingCoaches->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Coach Aktif</p>
            ...
            <div class="bg-white rounded-lg shadow mb-6 p-4">
                <form id="searchForm" method="GET" action="{{ route('admin.coaches.pending') }}" class="flex flex-wrap gap-4 items-end">
                    <div class="flex-1 min-w-64">
                        <label for="search" class="block text-sm font-medium text-gray-700 mb-2">Cari Coach</label>
                        <input type="text" name="search" id="search" value="{{ request('search') }}"
                            placeholder="Nama atau email coach..."
            ...
            <div id="coachesContainer">
                @include('admin.coaches._pending_list', ['pendingCoaches' => $pendingCoaches])
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function performSearch() {
                ...
                searchTimeout = setTimeout(() => {
                    const url = new URL(window.location.origin + '/admin/coaches/pending');
