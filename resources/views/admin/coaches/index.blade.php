            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Kelola semua coach yang terdaftar dalam sistem</p>
                    </div>
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('admin.coaches.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
                            <i class="fas fa-plus mr-2"></i>Tambah Coach
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-3xl font-bold text-gray-900">{{ $activeCoaches }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Coach Non-aktif</p>
                            <p class="text-3xl font-bold text-gray-900">{{ $inactiveCoaches }}</p>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function performSearch() {
                ...
                searchTimeout = setTimeout(() => {
                    const url = new URL(window.location.origin + '/admin/coaches');
