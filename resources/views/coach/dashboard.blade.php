...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto mt-8 p-4">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-gray-600 mb-4">Anda login sebagai Coach di Web Renangku.</p>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-green-50 p-4 rounded">
                    <h3 class="font-semibold text-green-800">Kelola Jadwal</h3>
                    <p class="text-green-600">Atur jadwal latihan renang</p>
                </div>

                <div class="bg-blue-50 p-4 rounded">
                    <h3 class="font-semibold text-blue-800">Data Member</h3>
                    <p class="text-blue-600">Lihat data member yang terdaftar</p>
                </div>

                <div class="bg-yellow-50 p-4 rounded">
                    <h3 class="font-semibold text-yellow-800">Laporan</h3>
                    <p class="text-yellow-600">Buat laporan kegiatan latihan</p>
                </div>
            </div>
        </div>
    </div>
